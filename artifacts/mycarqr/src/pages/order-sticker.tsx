...
import { Package, Upload, Copy, CheckCircle, Truck, ShoppingCart, ArrowRight } from "lucide-react";
      ...
      <div className="p-4 sm:p-6 max-w-2xl mx-auto space-y-6">
        ...
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardDescription>
              Transfer ₹{product.price} to the UPI ID below, then upload your payment screenshot
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardDescription>Attach a screenshot after completing the UPI transfer</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <label className="flex flex-col items-center gap-2 border-2 border-dashed rounded-xl p-6 cursor-pointer hover:border-primary transition-colors">
              ...
              <span className="text-sm text-muted-foreground">
                {fileName ? fileName : "Click to upload payment screenshot (optional but recommended)"}
              </span>
        ...
        <div className="flex gap-3">
          ...
          >
            {createOrder.isPending ? "Placing Order…" : `Place Order — ₹${product.price}`}
          </Button>
        </div>
      </div>
    );
    ...
    <div className="p-4 sm:p-6 max-w-2xl mx-auto space-y-6">
      <Card className="border-green-300 bg-green-50 dark:bg-green-950/20">
        <CardContent className="p-6 flex flex-col items-center text-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-green-800 dark:text-green-300">Order Placed!</h2>
            <p className="text-green-700 dark:text-green-400 text-sm mt-1">
              Order #{orderId} received. Admin will verify payment and ship your sticker within 3–5 business days.
            </p>
          </div>
