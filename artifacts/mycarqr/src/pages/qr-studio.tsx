  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex flex-col lg:flex-row gap-0 h-[calc(100vh-57px)]">
        {/* ── Left Panel: Controls ───────────────────────── */}
        <div className="lg:w-80 lg:border-r lg:overflow-y-auto flex-shrink-0">
          <Tabs defaultValue="templates" className="h-full flex flex-col">
            ...
            <TabsContent value="templates" className="flex-1 overflow-y-auto p-4 mt-0">
              ...
              {!isPremiumUser && (
                <Card className="mt-4 p-3 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-950/30 dark:to-orange-950/30 border-yellow-200 dark:border-yellow-800">
                  <div className="flex items-start gap-2">
                    <Crown className="w-4 h-4 text-yellow-600 mt-0.5 shrink-0" />
                    <div>
                      <p className="text-xs font-semibold text-yellow-800 dark:text-yellow-300">Upgrade for premium themes</p>
                      <p className="text-xs text-yellow-700 dark:text-yellow-400 mt-0.5">Sporty Red, Royal Gold, Neon Blue, Army Green &amp; more</p>
                      <Link href="/payment">
                        <Button size="sm" className="mt-2 h-7 text-xs bg-yellow-600 hover:bg-yellow-700">
                          View Plans — ₹99/mo
                        </Button>
                      </Link>
                    </div>
            ...
            {/* Content tab */}
            <TabsContent value="content" className="flex-1 overflow-y-auto p-4 mt-0 space-y-5">
              <div className="space-y-2">
            ...
            {/* Style tab */}
            <TabsContent value="style" className="flex-1 overflow-y-auto p-4 mt-0 space-y-5">
              <div className="space-y-2">
            ...
            {/* Size tab */}
            <TabsContent value="size" className="flex-1 overflow-y-auto p-4 mt-0 space-y-4">
        ...
        {/* ── Right Panel: Preview ───────────────────────── */}
        <div className="flex-1 flex flex-col items-center overflow-y-auto bg-muted/30 p-4 gap-5">
          {/* Preview mode toggle */}
